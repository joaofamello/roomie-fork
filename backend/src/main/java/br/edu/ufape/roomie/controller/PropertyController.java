...
public class PropertyController {
  ...
  public ResponseEntity<List<Property>> getAll(
    ...
    String type =
        (propertyType != null && !propertyType.isBlank()) ? propertyType.toUpperCase() : "[ALL]";
  ...
  public ResponseEntity<List<PropertyDetailView>> getMyResidentProperties(
  ...
  public ResponseEntity<?> publishProperty(@PathVariable Long id, Authentication authentication) {
    ...
    if (!property.getOwner().getId().equals(user.getId())) {
      return ResponseEntity.status(HttpStatus.FORBIDDEN)
          .body("Você não tem permissão para publicar este imóvel.");
    }
  ...
  public ResponseEntity<Map<String, Long>> setPropertyToDraft(
    ...
    try {
      ...
      return ResponseEntity.ok(
          Map.of(
              ...
              studentId,
              "message",
              "Estudante confirmado com sucesso na moradia."));
    } catch (ResponseStatusException e) {
