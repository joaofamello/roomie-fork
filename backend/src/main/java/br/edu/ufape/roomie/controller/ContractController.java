...
public class ContractController {
  ...
  public ResponseEntity<?> createContract(
      @RequestBody ContractRequestDTO request, @AuthenticationPrincipal User loggedInUser) {
    try {
  ...
  public ResponseEntity<?> getContractsByChat(
      @PathVariable Long chatId, @AuthenticationPrincipal User loggedInUser) {
    try {
      List<ContractResponseDTO> contracts =
          contractService.getContractsByChat(chatId, loggedInUser);
