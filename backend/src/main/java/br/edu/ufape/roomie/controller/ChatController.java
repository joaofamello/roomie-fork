...
public class ChatController {
  ...
  /** Inicia um chat (apenas proprietário). POST /api/chats */
  @PostMapping
  public ResponseEntity<?> startChat(
      @RequestBody ChatRequestDTO request, @AuthenticationPrincipal User loggedInUser) {
    try {
  ...
  /** Lista todos os chats do usuário logado. GET /api/chats */
  @GetMapping
  ...
  /** Retorna detalhes de um chat. GET /api/chats/{id} */
  @GetMapping("/{id}")
  public ResponseEntity<?> getChat(
      @PathVariable Long id, @AuthenticationPrincipal User loggedInUser) {
    try {
  ...
  /** Retorna as mensagens de um chat e marca como lidas. GET /api/chats/{id}/messages */
  ...
  /** Envia uma mensagem em um chat. POST /api/chats/{id}/messages */
