...
@WebMvcTest(controllers = ExpenseController.class, excludeAutoConfiguration = UserDetailsServiceAutoConfiguration.class)
...
class ExpenseControllerTest {
    ...
    @Autowired
    private JacksonTester<ExpenseRequestDTO> expenseRequestDTOJacksonTester;
    ...
    void testaCriarDespesaComSucesso() throws Exception {
        ...
        var response = mvc.perform(post("/api/expenses")
    ...
    void testaBuscarResumoDespesasDaMoradia() throws Exception {
        ...
        var response = mvc.perform(get("/api/expenses/property/10"))
                .andReturn().getResponse();
