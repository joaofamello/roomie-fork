...
class ChatServiceTest {
  ...
  @Test
  @DisplayName(
      "Deve simular chats duplicados e listagem completa ignorando seen.add se já visto no mesmo array")
  void deveNãoDuplicarChatsDaMesmaFuncao() {
    // Criando duas referências do mesmo chat só para testar a branch em que seen.add(c.getId()) é
    // FALSE
