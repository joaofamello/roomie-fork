...
class HabitServiceTest {
  ...
  void getHabit_studentNotFound_throws404() {
    ...
    ResponseStatusException ex =
        assertThrows(
            ResponseStatusException.class, () -> habitService.getHabitByStudent(mockStudent));
  ...
  @Test
  @DisplayName(
      "Deve ignorar elementos vazios ou nulos nas listas (Hobbies, LifeStyles, CleaningPrefs)")
  ...
  @Test
  @DisplayName(
      "Deve limpar listas corretamente com entradas null no DTO (Hobbies, LifeStyles, CleaningPrefs)")
